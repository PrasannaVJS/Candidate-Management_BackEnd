...
class BackendAuApplicationTests {
	...
	public void getCandidatesTest1() {
		when(candidatedao.getAllCandidates()).thenReturn(Stream.of(
				new Candidate2(1,"Vj Prasanna","Shivajee","svprasanna04@gmail.com","Bangalore","good","Intern",2056401287,true,true,false,false,false),
				new Candidate2(2,"Prasanna","Shivajee","svprasanna04@gmail.com","Mumbai","Super","HR",1056401287,true,true,false,false,false))
	...
	public void getUserByLocationTest() {
		when(candidatedao.getCandidateByLocation("Chennai")).thenReturn(Stream.of(
				new Candidate2(1,"Vj Prasanna","Shivajee","svprasanna04@gmail.com","anylocation","good","Intern",2056401287,true,true,false,false,false),
				new Candidate2(2,"Prasanna","Shivajee","svprasanna04@gmail.com","Mumbai","Super","HR",1056401287,true,true,false,false,false))
				.collect(Collectors.toList()));
	  ...
	  when(candidatedao.getCandidateByJob("Employee")).thenReturn(Stream.of( new
			  Candidate2(1,"Vj Prasanna","Shivajee","svprasanna04@gmail.com","anylocation","good","Intern",2056401287,true,true,false,false,false))
			  .collect(Collectors.toList()));
	  ...
	  public void updateUserTest() {
		  Candidate2 c1=new Candidate2(1,"Vj Prasanna","Shivajee","svprasanna04@gmail.com","anylocation","good","Intern",2056401287,true,true,false,false,false);
	  ...
	  @Test public void addUserTest() { 
		  Candidate2 c1=new Candidate2("Vj Prasanna","Shivajee","svprasanna04@gmail.com","Bangalore","good","Intern",2056401287,true,true,false,false,false);
