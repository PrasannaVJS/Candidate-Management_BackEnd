...
public class Candidate2 {
	...
	public Candidate2(int id, String firstname, String lastname, String emailID, String location, String feedback,
			String jobdescrip, long contactno, boolean cpp, boolean java, boolean python, boolean angular,
			boolean spring) {
		super();
		this.id = id;
	...
	public Candidate2(String firstname, String lastname, String emailID, String location, String feedback,
			String jobdescrip, long contactno, boolean cpp, boolean java, boolean python, boolean angular,
			boolean spring) {
		super();
		this.firstname = firstname;
	...
	public String toString() {
		return "Candidate2 [id=" + id + ", firstname=" + firstname + ", lastname=" + lastname + ", emailID=" + emailID
